...
class Actual_model extends CI_Model
{
    ...
    public function summary($thn){
        ...
        ON tstation.id_station = tdivision.id_station WHERE tdetail_budget.budget_year = '.$thn.' 
        GROUP BY tdetail_budget.id_user ASC ORDER BY tstation.code_station asc')->result_array();
