    <div class="container-fluid">
        ...
        <div class="card shadow mb-12">
            ...
            <div class="card-body">
                <form method="POST" action="<?= base_url('admin/addperiode') ?>" class="row g-3" enctype="multipart/form-data">
                    <div class="col-12">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" name="start" class="form-control" id="datepicker" placeholder="00/00/0000">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" name="end" class="form-control" id="datepickerr" placeholder="00/00/0000">
