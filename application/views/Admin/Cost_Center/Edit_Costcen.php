            ...
            <div class="col-lg-12">
                ...
                <div class="card shadow mb-12">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Edit Cost Center</h6>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="<?= base_url('admin/editcostcen/' . $costcen["id_costcen"]) ?>" class="row g-3" enctype="multipart/form-data">
                            <div class="col-12">
                                <label for="inputNanme4" class="form-label">Code Cost Center</label>
                                <input type="text" name="code" class="form-control" id="code" value="<?= $costcen["code_costcen"] ?>">
