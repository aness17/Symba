                    ...
                    <div class="card-body">
                        <form method="POST" action="<?= base_url('budget/editbudget/' . $bg["id_budget"])?>" class="row g-3" enctype="multipart/form-data">
                            ...
                            <div class="col-12">
                                ...
                                <select name="acc" class="form-control" id="exampleFormControlSelect1" name="cc">
                            ...
                            <div class="col-12">
                                ...
                                <select name="user" class="form-control" id="exampleFormControlSelect1" name="user">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="cur" class="form-control" id="cur" value="<?= $bg['currency'] ?>">
                                <?= form_error('cur', '<small class="form-text text-danger">', '</small>'); ?>
                            </div>
                            <div class="col-12">
                                <label for="inputNanme4" class="form-label">Accounted DR Amount</label>
                                <input type="number" name="debit" class="form-control" id="debit" value="<?= $bg['amount_debit'] ?>">
