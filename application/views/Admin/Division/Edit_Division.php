        ...
        <!-- <div class="row ml-1">
            <div class="col-lg-12"> -->
                ...
                <div class="card shadow mb-12">
                    ...
                    <div class="card-body">
                        <form method="POST" action="<?= base_url('admin/editdvn/' . $dvn["id_dvn"]) ?>" class="row g-3" enctype="multipart/form-data">
                            <div class="col-12">
                                <label for="inputNanme4" class="form-label">Division</label>
                                <input type="text" name="dvn" class="form-control" id="dvn" value="<?= $dvn['division'] ?>">
                            ...
                            <div class="col-12">
                                ...
                                <select name="dpt" class="form-control" id="exampleFormControlSelect1" name="dpt">
                                    ...
                                    <?php
                                    foreach ($dpt as $dpt) : ?>
                                        <option value="<?= $dpt['id_dpt'] ?>" <?= ($dvn["id_dpt"] == $dpt['id_dpt']) ? "selected" : "" ?>><?= $dpt['name_dpt'] ?></option>
                                    <?php endforeach; ?>
                                </select>
                            ...
                            <div class="col-12">
                                ...
                                <select name="cc" class="form-control" id="exampleFormControlSelect1" name="cc">
                                    ...
                                    <?php
                                    foreach ($cc as $cc) : ?>
                                        <option value="<?= $cc['id_costcen'] ?>"<?= $dvn["id_costcen"]==$cc['id_costcen'] ? "selected" : "" ?>><?= $cc['code_costcen'] ?>-<?=$cc['name_costcenter'] ?></option>
                                    <?php endforeach; ?>
                                </select>
                            ...
                            <div class="col-12">
                                ...
                                <select name="lob" class="form-control" id="exampleFormControlSelect1" name="lob">
                                    ...
                                    <?php
                                    foreach ($lob as $lob) : ?>
                                        <option value="<?= $lob['id_lob'] ?>"<?= ($dvn["id_lob"] == $lob['id_lob']) ? "selected" : "" ?>><?=$lob['name_lob'] ?></option>
                                    <?php endforeach; ?>
                                </select>
                            ...
                            <div class="col-12">
                                ...
                                <select name="station" class="form-control" id="exampleFormControlSelect1" name="station">
                                    ...
                                    foreach ($station as $station) : ?>
                                        <option value="<?= $station['id_station'] ?>"<?= ($dvn["id_station"] == $station['id_station']) ? "selected" : "" ?>><?=$station['name_station'] ?></option>
                                    <?php endforeach; ?>
                                </select>
